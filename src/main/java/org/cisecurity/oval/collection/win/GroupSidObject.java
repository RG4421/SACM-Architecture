 ...
 *           &lt;sequence>
 *             &lt;element name="group_sid" type="{http://oval.cisecurity.org/XMLSchema/oval-collections-6}ObjectStringType"/>
    ...
    extends ObjectType
{
    ...
    protected ObjectStringType groupSid;
     ...
     *     
     */
    public ObjectStringType getGroupSid() {
        return groupSid;
    }
     ...
     *     
     */
    public void setGroupSid(ObjectStringType value) {
        this.groupSid = value;
    }
