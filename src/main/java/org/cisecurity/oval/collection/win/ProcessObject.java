 ...
 *           &lt;sequence>
 *             &lt;element name="command_line" type="{http://oval.cisecurity.org/XMLSchema/oval-collections-6}ObjectStringType"/>
    ...
    extends ObjectType
{
    ...
    protected Set set;
    @XmlElementRef(name = "command_line", namespace = "http://oval.cisecurity.org/XMLSchema/oval-collections-6#windows", type = JAXBElement.class, required = false)
    protected JAXBElement<ObjectStringType> commandLine;
     ...
     *     
     */
    public JAXBElement<ObjectStringType> getCommandLine() {
        return commandLine;
    }
     ...
     *     
     */
    public void setCommandLine(JAXBElement<ObjectStringType> value) {
