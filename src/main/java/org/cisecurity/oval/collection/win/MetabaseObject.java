 ...
 *             &lt;element name="id" type="{http://oval.cisecurity.org/XMLSchema/oval-collections-6}ObjectIntType"/>
    ...
    extends ObjectType
{
    ...
    @XmlElementRef(name = "id", namespace = "http://oval.cisecurity.org/XMLSchema/oval-collections-6#windows", type = JAXBElement.class, required = false)
    protected JAXBElement<ObjectIntType> id2;
     ...
     *     
     */
    public JAXBElement<ObjectIntType> getId2() {
        return id2;
    }
     ...
     *     
     */
    public void setId2(JAXBElement<ObjectIntType> value) {
        this.id2 = value;
    }
