...
/**
 * <p>Java class for DatatypeEnumeration.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="DatatypeEnumeration">
 ...
 * 
 */
@XmlType(name = "DatatypeEnumeration")
@XmlEnum
public enum DatatypeEnumeration {
    ...
    public static DatatypeEnumeration fromValue(String v) {
        for (DatatypeEnumeration c: DatatypeEnumeration.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
